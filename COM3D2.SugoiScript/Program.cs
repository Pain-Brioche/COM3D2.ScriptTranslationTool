    ...
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            if (scriptCount > 0)
            {
                ...
                Tools.WriteLine("Script translation done, you may recover them in Scripts\\i18nEx and copy them in your game folder.", ConsoleColor.Green);
            }
        ...
        internal static void OptionMenu()
        {
            ...
            while (key.Key != ConsoleKey.Enter)
            {
                ...
                if ((key.Key == ConsoleKey.D8) || (key.Key == ConsoleKey.NumPad8)) { Db.Clean(); }
                ...
                Console.WriteLine($" 8. Clean the Database: ");
                Console.WriteLine($" 9. Clear Machine Translations");
                Console.Write("Press Numbers for options or Enter to start translating: ");
